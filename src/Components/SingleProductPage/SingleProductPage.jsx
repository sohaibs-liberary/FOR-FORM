        ...
        <div className="product  ">
          ...
          <div className="details lg:flex lg:justify-around  ">
            ...
            <div className="text-section">
                ...
                {data.length > 0 ? (
                  data.slice(0, 1).map((detail, index) => (
                    <div key={index}  className="grid gap-5" >
                     <h1 className="title text-4xl font-semibold" > {detail.title}</h1>
                     <h2 className="title text-2xl font-semibold text-gray-500 "  >{detail.slug}</h2>
                     <h6  className="title text-2xl  text-gray-500 text-wrap "  >{detail.description}</h6>
                    </div>
                  ))
                ) : (
                  <p>Loading...</p>
              ...
              <div className="incresesanddesreaces"></div>
              <div className="btn">
                <button className="bg-gray-950 text-white text-2xl font-sans py-3 px-32 rounded-md" >Add To Cart</button>
              </div>
            </div>
          </div>
        </div>
